...
/**
 * This class represents an "date/time" adaptor for an integer field in a database
 * table.
 *
 * @package Leap
 * @category ORM
 ...
 * @abstract
 */
abstract class Base_DB_ORM_Field_Adaptor_DateTime extends DB_ORM_Field_Adaptor {
