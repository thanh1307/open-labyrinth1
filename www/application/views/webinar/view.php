...
if(!empty($templateData['webinars']) && count($templateData['webinars']) > 0) {
    echo 'Vui lòng chọn kịch bản, sử dụng danh sách thả xuống ở bảng menu trên cùng.';
}else{
    echo 'Không có kịch bản có sẵn ngay bây giờ. Bạn có thể thêm kịch bản bằng nút thêm.';
}