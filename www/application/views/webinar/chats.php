    ...
    <div class="panel chat ttalk" id="<?php echo $chat_id ?>">
        ...
        <div class="panel-body">
            ...
            <div style="border-bottom:1px solid #eee;padding:0 0 10px">
                <textarea class="chat-textarea ttalk-textarea" placeholder="Nhập câu trả lời của bạn..." style="height:60px;"></textarea>
                <button class="ttalkButton btn btn-primary" style="width:100%">Gửi</button>
            </div>
            ...
            <div class="form-inline" style="border-bottom:1px solid #eee;padding:10px 0">
                <select class="redirect_node_id" disabled><option value="">- Chuyển hướng đến... -</option></select>
                <i class="ttalkRedirectButton icon icon-arrow-right btn btn-small btn-success" title="Chuyển hướng!"></i>
            </div>

            <div>
                <div>NodeId: <b class="node_id"></b></div>
                <div>Tiêu đề Node: <b class="node_title"></b></div>
