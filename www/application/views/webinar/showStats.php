...
<div class="page-header">
    <h1><?php echo __('Quá trình cho ').' '.$templateData['webinar']->title; ?></h1>
</div>
...
<?php if(isset($templateData['webinar']) && isset($templateData['webinarData']) && isset($templateData['usersMap'])) { ?>
    <table class="table table-striped table-bordered" id="my-labyrinths">
        ...
        <tr>
            ...
            <td style="text-align: center; font-weight: bold; background: #FFFFFF;font-style: normal; font-size: 14px" rowspan="2">Đưa vào báo cáo</td><?php
            $stepsHeaders = array();
                    ...
                    if(!isset($stepsHeaders[$stepKey]) || $stepsHeaders[$stepKey]['count'] < count($step)) {
                        ...
                        $stepsHeaders[$stepKey]['html']  = '<td colspan="' . $stepsHeaders[$stepKey]['count'] . '">' .
                            (isset($templateData['webinarStepMap'][$stepKey]) ? ($templateData['step'] == $stepKey) ? '<span style="color:#0088cc;font-weight:bold">' . $templateData['webinarStepMap'][$stepKey]->name . '</span>'
                                ...
                                : '-') .
                                                                ($isShowReport ? ' <a title="" data-original-title="Get 4R report for this step" href="' . URL::base() . 'webinarManager/stepReport4R/' . $templateData['webinar']->id . '/' . $stepKey . '/' .  $templateData['dateId'].'" style="text-decoration: none;font-size: 130%;"><i class="icon-eye-open"></i></a>
        ...
        <tr>
            ...
            foreach($maps as $stepKey => $m) {
                ...
                <td style="text-align: center; font-weight: bold;">
                    <?php echo $v['map']->name; ?>
                    <?php if($v['showReport']) { ?>
                        <a title="" data-original-title="Nhận báo cáo 4R cho hệ thống này" href="<?php echo URL::base(); ?>webinarManager/mapReport4R/<?php echo $templateData['webinar']->id; ?>/<?php echo $v['map']->id; ?>/<?php echo $templateData['dateId']; ?>" style="text-decoration: none;"><i class="icon-eye-open"></i></a>
                    <?php } ?>
                </td><?php
                }
            } ?>
    ...
    <div class="form-actions">
        <div class="pull-right">
            <a class="btn btn-info" href="<?php echo URL::base().'dforumManager/viewForum/'.$templateData['webinar']->forum_id; ?>">
