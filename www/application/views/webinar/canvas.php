...
<div class="block">
    <div class="block" style="position: relative;" id="canvasContainer">
        ...
        <div style="position: absolute;left:50%;z-index: 1500;" id="ve_message" class="alert alert-success hide"><span id="ve_message_text">Tin nhắn</span></div>
    ...
    <div class="modal hide block" id="visual_editor_link">
        ...
        <div class="modal-body block" align="center">
            <div class="block" data-toggle="buttons-radio" id="linkTypes">
                ...
                <button type="button" class="btn" value="dual">Kết hợp</button>
    ...
    <div class="visual-editor-select-right-panel scenario hide" id="veStepPanel">
        <div class="step-header">Bước</div>
        <div class="step-body">
            <label>
                <strong>Chọn bước:</strong>
                <br>
            ...
            <div class="step-settings">
                <label class="control-label"><strong>Cài đặt các bước:</strong></label>
                <div class="controls">
                    <input type="text" id="stepName" style="margin-bottom: 20px;"/>
                    <div class="btn-group">
                        <button id="stepUpdate" class="btn btn-info">Cập nhật</button>
                        <button id="addToStep" class="btn btn-success">Thêm lựa chọn</button>
                        <button id="addStep" class="btn btn-success">Thêm bước</button>
