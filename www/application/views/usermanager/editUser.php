...
<div class="page-header">
    <div class="pull-right"><?php
        ...
        <a class="btn btn-danger" href="<?php echo URL::base().'usermanager/deleteUser/'.$templateData['user']->id; ?>">
            <i class="icon-trash"></i><?php echo __('Xóa người dùng'); ?>
        </a><?php
        }?>
    </div>
    <h1><?php echo __('Chỉnh sửa')." ".__('Tài khoản người dùng'); ?></h1>
</div>
...
<form class="form-horizontal" action="<?php echo URL::base().'usermanager/saveOldUser/'.$templateData['user']->id; ?>" method="post">
    <fieldset class="fieldset">
        <legend><?php echo __("Chi tiết người dùng");?></legend>
        <div class="control-group">
            <label class="control-label"><?php echo __('Tên người dùng'); ?></label>
            <div class="controls" style="margin-top: 5px;"><?php echo $templateData['user']->username; ?></div>
        </div>
        <div class="control-group">
            <label for="upw" class="control-label"><?php echo __('Mật khẩu mới'); ?></label>
            <div class="controls">
                <input id="upw"  type="password" name="upw" value="">
                <span class="help-inline">Mật khẩu sẽ được thay đổi nếu giá trị không trống</span>
            </div>
        </div>
        <div class="control-group">
            <label for="uname" class="control-label"><?php echo __('Tên'); ?></label>
            <div class="controls">
            ...
            <div class="controls">
                <div class="helpPopupLine">
                    <div class="radio_extended btn-group">
                        <a href="<?php echo URL::base().'base/ui/easy/'.$user->id; ?>" data-class="btn-info" class="btn <?php if ($user->modeUI == 'easy') echo 'active btn-info'; ?>">Cơ bản</a>
                        <a href="<?php echo URL::base().'base/ui/advanced/'.$user->id; ?>" data-class="btn-info" class="btn <?php if ($user->modeUI == 'advanced') echo 'active btn-info'; ?>">Nâng cao</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="form-actions">
        <div class="pull-right">
            <input class="btn btn-primary btn-large" type="submit" name="EditUserSubmit" value="<?php echo __('Lưu thay đổi'); ?>">
        </div>
    </div>
</form><?php
} ?>
