...
<div class="page-header">
    ...
    <h1><?php echo __('Chỉnh sửa tin nhắn'); ?></h1></div>
...
<fieldset class="fieldset">
    ...
    <div class="control-group">
        <label for="message" class="control-label"><?php echo __('Chỉnh sửa tin nhắn: '); ?></label>
    ...
    <div class="form-actions">
        <div class="pull-right">
            <input class="btn btn-large btn-primary" type="submit" name="Submit"
                   value="<?php echo __('Chỉnh sửa'); ?>" onclick="return CheckForm();"></div>
    </div>
