...
<div class="page-header">
    <h1><?php echo __('Chỉnh sửa diễn đàn') . ' - "' .  $templateData['name'] . '"'; ?></h1>
</div>
...
<form class="form-horizontal" id="form1" name="form1" method="post"
    ...
    <fieldset class="fieldset">
        <div class="control-group">
            ...
            <div class="controls">
                <label class="radio">
                    <input name="security" type="radio" value="0" <?php if ($templateData['security'] == 0) echo 'checked="checked"'; ?> ><?php echo __('Mở'); ?>
                </label>
            </div>
            <div class="controls">
                <label class="radio">
                    <input name="security" type="radio" value="1" <?php if ($templateData['security'] == 1) echo 'checked="checked"'; ?>><?php echo __('Bảo mật'); ?>
                </label>
    ...
    <div class="form-actions">
        <div class="pull-right">
            <input class="btn btn-large btn-primary" type="submit" name="Submit"
                   value="<?php echo __('Chỉnh sửa diễn đàn'); ?>" onclick="return CheckForm();"></div>
    </div>
</form>
