    ...
    <table bgcolor='#ffffff' cellpadding='6' width='100%'>
        <tr>
            <td valign="top" width="20%">
                ...
                <h5> <font color="#000000"><?php echo __(''); ?></font></h5>
                <hr />
                <h5><font color="#000000"></font></h5>
            </td>
            <td bgcolor='#ffffff' align='left' valign="top">
                <table width="100%" height="100%" cellpadding='6'>
                    <tr>
                        <td valign="top" bgcolor="#bbbbcb">
                            <h4><?php echo __('Cần có mã khóa để truy cập ') . '"' . $templateData['mapDB']->name . '"'; ?></h4>
                            <form name="securityForm" method="post" action="<?php echo URL::base().'renderLabyrinth/checkKey/'.$templateData['mapDB']->id; ?>">
                                <table style="padding-top:20px; padding-bottom: 20px;" bgcolor="#FFFFFF" width="100%" border="0" cellspacing="0" cellpadding="4">
                                    <tr>
                                        <td width="33%" align="right"><p><?php echo __('Nhập mã khóa: '); ?></p></td>
                                        <td width="50%"><p><input class="not-autocomplete" name="securityKey" type="password" id="securityKey" size="40" value="" autocomplete="off" />&nbsp;<input type="submit" value="<?php echo __('Gửi'); ?>" /></p></td>
                                    </tr>
