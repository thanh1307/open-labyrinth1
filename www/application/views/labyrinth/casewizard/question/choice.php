...
<h4><?php echo (__('New question for "').$templateData['map']->name.'"'); ?></h4>
...
<?php } ?>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="radio_extended btn-group">
                    <input autocomplete="off" id="question_type_mcq" type="radio" value="3" name="question_type" <?php if
                    (isset($templateData['type'])) echo ($templateData['type']->id == 3) ? 'checked="checked"' : '';
    ...
    <input class="btn btn-primary" type="submit" name="Submit" value="Lưu thay đổi">
</form>
<?php } ?>
