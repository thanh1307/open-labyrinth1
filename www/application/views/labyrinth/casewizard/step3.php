...
<h1><?php echo __('Bước 3. Sáng tạo VP'); ?> - <?php if (isset($templateData['map'])) echo $templateData['map']->type->name; ?></h1>
    ...
    ?>/<?php echo $templateData['map']->id; ?>">
        ...
        <div class="block">
            <div class="block" data-toggle="buttons-radio" id="nodeCountContainer">
                ...
                <button type="button" class="btn" value="Custom" id="nodeCountCustom">Tùy chỉnh</button>
                <input type="text" style="width: 40px;" id="nodeCount" disabled/>
                <button class="btn" id="applyCount">Áp dụng</button>
            </div>
        </div>
        <br/>
        <div id="entryPointContainer">
            <legend><?php echo __('Điểm đầu vào'); ?></legend>
            <div class="control-group">
                <label for="rootTitle" class="control-label"><?php echo 'Tiêu đề';?></label>
            ...
            <div class="control-group">
                <label for="rootContent" class="control-label"><?php echo 'Nội dung';?></label>
        ...
        <div id="endPointContainer">
            <legend><?php echo __('Điểm kết thúc'); ?></legend>
            <div class="control-group">
                <label for="endTitle" class="control-label"><?php echo 'Tiêu đề';?></label>
            ...
            <div class="control-group">
                <label for="endContent" class="control-label"><?php echo 'Nội dung';?></label>
        ...
        <footer>
            <div class="pull-right"><button type="submit" id="step3_submit" class="btn btn-primary wizard_button">Bước 4 - Chỉnh sửa câu chuyện</button></div>
            <a href="<?php echo URL::base() . 'labyrinthManager/caseWizard/2/' . $templateData['map']->id; ?>" style="float:left;" class="btn btn-primary wizard_button">Quay lại bước 2</a>
        </footer>
