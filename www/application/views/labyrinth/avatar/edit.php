...
<form class="form-horizontal" method="POST"
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <select id="sex" size="1" name="avsex">
                    <option <?php if ($templateData['avatar']->sex == 'male') echo 'selected=""'; ?> value="male">Nam
                    </option>
    ...
    <div class="tab-pane" id="face">
        ...
        <div class="control-group">
            <label for="mouth" class="control-label">Hình dáng miệng</label>
        ...
        <div class="control-group">
            <label for="eyes" class="control-label">Mắt</label>
    ...
    <div class="tab-pane" id="hairskin">
        <div class="control-group">
            <label for="hairtype" class="control-label">Kiểu tóc</label>
        ...
        <div class="control-group">
            <label for="haircolor" class="control-label">Màu tóc</label>
        ...
        <div class="control-group">
            <label for="skintone" class="control-label">Tông Màu Da (Tô)</label>
