...
if (isset($templateData['map'])) { ?>
    ...
    <div class="page-header"><h1><?php echo __('Chỉnh sửa người dùng hệ thống "').$templateData['map']->name.'"'; ?></h1></div>
    ...
    <form class="form-horizontal" method="POST" action="<?php echo URL::base().'mapUserManager/addUser/'.$templateData['map']->id.(isset($templateData['authorOrder']) ? '/'.$templateData['authorOrder'] : '') . (isset($templateData['learnerOrder']) ? '/'.$templateData['learnerOrder'] : ''); ?>">
        <div class="pull-right"><input type="submit" class="btn btn-primary btn-large" name="GlobalSubmit" value="<?php echo __('Lưu thay đổi'); ?>"></div>

        <h3><?php echo __('Nhóm'); ?></h3>
        <div class="btn-group users" style="margin-bottom: 10px">
            <a class="btn btn-primary" href="<?php echo URL::base(); ?>mapUserManager/addAllGroups/<?php echo $templateData['map']->id; ?>/<?php echo $templateData['authorOrder']; ?>/<?php echo $templateData['learnerOrder']; ?>">Thêm tất cả</a>
            <a class="btn btn-danger" href="<?php echo URL::base(); ?>mapUserManager/removeAllGroups/<?php echo $templateData['map']->id; ?>/<?php echo $templateData['authorOrder']; ?>/<?php echo $templateData['learnerOrder']; ?>">Xóa tất cả</a>
        </div>
            ...
            <tr>
                ...
                <th>
                    <a href="<?php echo URL::base().'mapUserManager/index/'.$templateData['map']->id.'/'.$templateData['authorOrder'].'/'.$templateData['learnerOrder'].'/'.$templateData['reviewerOrder'].'/'.(1 - $templateData['groupOrder']); ?>">
                        Groups <div class="pull-right"><i class="icon-chevron-<?php if($templateData['groupOrder'] == 1) echo 'xuống';  else  echo 'lên'; ?> icon-white"></i></div>
                </th>
            </tr>
            </thead>
            <tbody>
        ...
        <div class="btn-group users" style="margin-bottom: 10px">
            <a class="btn btn-primary" href="<?php echo URL::base(); ?>mapUserManager/addAllAuthors/<?php echo $templateData['map']->id; ?>/<?php echo $templateData['authorOrder']; ?>/<?php echo $templateData['learnerOrder']; ?>">Thêm tất cả</a>
            <a class="btn btn-danger" href="<?php echo URL::base(); ?>mapUserManager/removeAllAuthors/<?php echo $templateData['map']->id; ?>/<?php echo $templateData['authorOrder']; ?>/<?php echo $templateData['learnerOrder']; ?>">Xóa tất cả</a>
        </div>
            ...
            <tr>
                ...
                <th>
                    <a href="<?php echo URL::base().'mapUserManager/index/'.$templateData['map']->id.'/'.(1 - $templateData['authorOrder']).'/'.$templateData['learnerOrder'].'/'.$templateData['reviewerOrder'].'/'.$templateData['groupOrder']; ?>">
                        Users <div class="pull-right"><i class="icon-chevron-<?php if($templateData['authorOrder'] == 1) echo 'xuống';  else  echo 'lên'; ?> icon-white"></i></div>
                    </a>
                </th>
            </tr>
            </thead>
        ...
        <h3><?php echo __('Người đánh giá'); ?></h3>
        <div class="btn-group users" style="margin-bottom: 10px">
            <a class="btn btn-primary" href="<?php echo URL::base().'mapUserManager/addAllReviewers/'.$templateData['map']->id; ?>">Thêm tất cả</a>
            <a class="btn btn-danger" href="<?php echo URL::base().'mapUserManager/removeAllReviewers/'.$templateData['map']->id; ?>">Xóa tất cả</a>
        </div>
            ...
            <tr>
                ...
                <th>
                    <a href="<?php echo URL::base().'mapUserManager/index/'.$templateData['map']->id.'/'.$templateData['authorOrder'].'/'.$templateData['learnerOrder'].'/'.(1 - $templateData['reviewerOrder']).'/'.$templateData['groupOrder']; ?>">
                        Users <div class="pull-right"><i class="icon-chevron-<?php echo ($templateData['reviewerOrder'] == 1) ? 'xuống' : 'lên'; ?> icon-white"></i></div>
                    </a>
                </th>
            </tr>
            </thead>
        ...
        <h3>Learners</h3>
        <div class="btn-group users" style="margin-bottom: 10px">
            <a class="btn btn-primary" href="<?php echo URL::base(); ?>mapUserManager/addAllLearners/<?php echo $templateData['map']->id; ?>/<?php echo $templateData['authorOrder']; ?>/<?php echo $templateData['learnerOrder']; ?>">Thêm tất cả</a>
            <a class="btn btn-danger" href="<?php echo URL::base(); ?>mapUserManager/removeAllLearners/<?php echo $templateData['map']->id; ?>/<?php echo $templateData['authorOrder']; ?>/<?php echo $templateData['learnerOrder']; ?>">Xóa tất cả</a>
        </div>
