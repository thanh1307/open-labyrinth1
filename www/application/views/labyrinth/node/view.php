...
if (isset($templateData['map'])) {
    ...
    <div class="pull-right">
        ...
        <h1><?php echo __('Chỉnh sửa các điểm của Labyrinth') . ' "' . $templateData['map']->name . '"'; ?></h1>
    </div>
                ...
                <td>
                    ...
                    <div class="modal hide alert alert-block alert-error fade in" id="delete-node-<?php echo $node->id; ?>">
                        ...
                        <div class="modal-body">
                            <p><?php printf(__('You have just clicked the delete button, are you certain that you wish to proceed with deleting "%s" node?'),$node->title); ?></p>
                            <p>
