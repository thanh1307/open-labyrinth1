    ...
    <div class="block">
        <div class="block" style="position: relative;" id="canvasContainer">
            ...
            <div class="visual-editor-right-panel hide" id="veRightPanel">
                ...
                <div class="footer block">
                    <div class="btn-group">
                        <a href="javascript:void(0)" class="btn btn-info" id="veRightPanelSaveBtn">Lưu thay đổi and close</a>
            ...
            <div class="visual-editor-select-right-panel hide" id="veSelectRightPanel">
                ...
                <div class="footer block">
                    <div class="btn-group">
                        ...
                        <a href="javascript:void(0)" class="btn btn-info" id="veSelectRightPanelSaveBtn">Lưu thay đổi và thoát</a>
            ...
            <div class="visual-editor-select-right-panel hide" id="veSectionPanel">
                ...
                <div class="control-group block" style="margin-left: 5px">
                    <label class="control-label"><strong>Phần lựa chọn:</strong></label>
                    <div class="controls">
                        <select id="sectionsNodesSelect"></select>
                    </div>

                    <div id="sectionSettings" class="hide">
                        <label class="control-label" style="text-align: left;"><strong>Tên:</strong></label>
                        <div class="controls">
                    ...
                    <div id="orderInSection" class="hide">
                        ...
                        <div class="controls">
                            ...
                            <label><input type="radio" class="orderInSection" name="orderInSection" data-value="random" value="random"/>Ngẫu nhiên</label>
                        </div>
                    </div>
        ...
        <div class="modal block hide" id="veMakeSectionBox">
            ...
            <div class="modal-footer block">
                ...
                <a href="javascript:void(0);" class="btn" data-dismiss="modal">Thoát</a>
            </div>
        </div>
        ...
        <div class="modal hide block" id="veRightPanel_unsaveddataChange">
            ...
            <div class="modal-footer block">
                <a href="javascript:void(0);" class="btn" id="veRightPanel_unsaveddataChange_close">Vẫn thay đổi điểm</a>
                <a href="javascript:void(0);" class="btn" data-dismiss="modal">Không thay đổi điểm</a>
            </div>
        </div>
        ...
        <div class="modal hide block" id="visual_editor_link">
            ...
            <div class="modal-body block" align="center">
                <div class="block" data-toggle="buttons-radio" id="linkTypes">
                    ...
                    <button type="button" class="btn" value="dual">Kép</button>
