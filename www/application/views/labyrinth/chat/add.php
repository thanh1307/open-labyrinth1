...
if (isset($templateData['map']) and isset($templateData['question_count'])) {
    ...
    <div class="page-header">
        <h1><?php echo __('Thêm tin nhắn'); ?></h1>
    </div>
    <form id="chatForm" class="form-horizontal" name="chatForm" method="post"
        ...
        <fieldset class="fieldset">
            <div class="control-group">
                <label for="cstem" class="control-label"><?php echo __('Đầy'); ?></label>
            ...
            <div class="control-group">
                <label for="scount" class="control-label"><?php echo __('Theo dõi điểm số với bộ đếm hiện có'); ?></label>
            ...
            <div class="control-group">
                <label class="control-label" for="is_private"><?php echo __('Bảo mật'); ?>
                </label>
                <div class="controls">
            ...
            <?php if (isset($templateData['question_count'])) { ?>
                <?php for ($i = 1; $i <= $templateData['question_count']; $i++) { ?>
                    <fieldset class="fieldset" id="qDiv<?php echo $i; ?>">
                        <legend><?php echo __("Câu hỏi #") . $i ?></legend>
                        <div class="control-group cQuestion">
                            <label for="question<?php echo $i; ?>" class="control-label"><?php echo __('Câu hỏi'); ?></label>
                        ...
                        <div class="control-group cResponce">
                            <label for="response<?php echo $i; ?>" class="control-label"><?php echo __('Phản hồi'); ?></label>
                        ...
                        <div class="control-group cCounter">
                            <label for="counter<?php echo $i; ?>" class="control-label"><?php echo __('Bộ đếm'); ?></label>
                        ...
                        <div class="form-actions">
                            <a class="btn btn-danger removeQuestionBtn" removeId="<?php echo $i; ?>" href="javascript:void(0);">
                                <i class="icon-minus-sign"></i>Xóa</a>
                        </div>
        ...
        <div class="form-actions">
            <div class="pull-left">
                <a class="btn btn-info" href="javascript:void(0)" id="addNewQuestion"><i class="icon-plus-sign"></i>Thêm câu hỏi mới</a>
            </div>
            <div class="pull-right">
                <input class="btn btn-primary btn-large" type="submit" name="Submit"
                       value="<?php echo __('Lưu thay đổi'); ?>">
            </div>
        </div>
    </form>
<?php } ?>