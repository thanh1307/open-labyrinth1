 ...
 *
 */ ?>
<h1><?php echo __('Tải MVP lên Hệ thống'); ?></h1>
...
<form class="form-horizontal" action="<?php echo URL::base(); ?>exportImportManager/upload" enctype="multipart/form-data" method="POST"><?php
    ...
    <fieldset class="fieldset">
        <div class="control-group">
            <label class="control-label"><?php echo __('Tải tệp'); ?></label>
            <div class="controls">
                <input type="file" name="filename">
                <div><span style="font-size: 14px; color: #333333;"><?php echo __('Dung lượng tối đa của tệp là 20.00 MB.'); ?></span></div>
            </div>
        </div>
    </fieldset>
    <div class="form-actions">
        <div class="pull-right">
            <input class="btn btn-large btn-primary" type="submit" value="<?php echo __('Tải lên'); ?>" name="Submit">
        </div>
    </div>
</form>
<img width="105" height="47" id="Img2" alt="MVP" src="<?php echo URL::base(); ?>images/medbiq_logo.gif">
<p>
    <?php echo __('Hệ thống nhập và xuất sang đặc tả dữ liệu bệnh nhân ảo MedBiquitous. Để biết thêm thông tin xem'); ?>
