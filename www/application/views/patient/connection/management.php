...
<div>
    <h3>Chọn kiểu</h3>
    <label><input type="radio" class="patient-type-js" name="ptj" data-type="same" checked>Cùng một người dùng</label>
    <label><input type="radio" class="patient-type-js" name="ptj" data-type="different">Khác người dùng</label>
...
<form class="form-horizontal" method="post" action="<?php echo URL::base().'patient/updateRule/'.$connectionId; ?>">
    ...
    <div class="pull-right" style="margin-top:10px;">
        <input style="float:right;" type="submit" id="check_button" class="btn btn-primary btn-large" value="<?php echo __('Lưu quy tắc'); ?>">
    </div>
    ...
    <div class="pull-left">
        <dl class="status-label dl-horizontal">
            ...
            <dd>
                <span class="label label-warning">Không thể kiểm tra quy tắc</span>
                <span class="label label-success hide">Quy tắc chính xác</span>
                <span class="label label-important hide">Quy tắc bị lỗi</span>
            </dd>
        </dl>
        <input style="float:left;" type="button" id="check_rule_button" class="btn btn-primary btn-large" data-loading-text="Checking..." value="<?php echo __('Kiểm tra quy tắc'); ?>">
    </div>
