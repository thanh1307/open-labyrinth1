...
<select id="choose-patient">
    <option data-href="<?php echo URL::base().'patient/labyrinth/'.$id_map; ?>">Chọn bộ</option><?php
...
Người dùng không được chỉ định vào hệ thống này. <?php
}?>
...
<form action="<?php echo URL::base().'patient/condition/'.$id_selected_patient; ?>" method="POST">
        ...
        <thead>
            <tr>
                ...
                <th style="width:155px;">
                    <?php echo __('Xuất hiện trên nút'); ?>
                    <a href="javascript:void(0)" class="btn btn-info btn-mini toggle-all-on" id="<?php echo $condition->id; ?>">tất cả bật</a>
                    <a href="javascript:void(0)" class="btn btn-info btn-mini toggle-all-off" id="<?php echo $condition->id; ?>">tất cả tắt</a>
                    <a href="javascript:void(0)" class="btn btn-info btn-mini toggle-reverse" id="<?php echo $condition->id; ?>">đảo ngược</a>
                </th><?php
                } ?>
            </tr>
        </thead>
        <tbody><?php
            ...
            <tr>
                ...
                <td>
                    ...
                    <label>
                        <input class="condition_checkbox <?php echo 'chk_'.$condition->id ?>" type="checkbox" value="1" name="<?php echo 'dbn['.$node->id.']['.$condition->id.'][appear]';?>" <?php if(isset($condition_data['appear']) AND $condition_data['appear']) echo 'checked'; ?>><?php echo __("xuất hiện trên nút"); ?>
                    </label>
                </td><?php
                } ?>
            </tr><?php
    ...
    <div class="pull-right"><input class="btn btn-primary btn-large" type="submit" value="<?php echo __('Lưu thay đổi'); ?>"></div>
</form><?php
} ?>