    ...
    <div class="pull-right">
        <div class="btn-group">
            <a class="btn" href="<?php echo URL::base(); ?>TodayTipManager/archive/<?php echo $templateData['tip']->id; ?>">
                ...
                <?php echo __('Di chuyển đến kho lưu trữ'); ?></a>
        </div>
    </div>
    <?php } ?>
    <h1><?php echo isset($templateData['tip']) ? __("Chỉnh sửa lời khuyên") : __('Thêm lời khuyên'); ?></h1>
</div>
...
<form class="form-horizontal" id="form" name="form" method="post" action="<?php echo URL::base(); ?>TodayTipManager/saveTip">
    ...
    <div class="control-group">
        <label class="control-label"><?php echo __('Kích hoạt'); ?></label>
        <div class="controls">
            <div class="radio_extended btn-group">
                ...
                <label data-class="btn-success" class="btn" for="tip_active_on">Hoạt động</label>
                ...
                <label data-class="btn-danger" class="btn" for="tip_active_off">Không hoạt động</label>
            </div>
        </div>
    </div>
    <fieldset class="fieldset">
        <div class="control-group">
            <label for="title" class="control-label"><?php echo __('Tiêu đề'); ?></label>
    ...
    <fieldset class="fieldset">
        <div class="control-group">
            <label for="text" class="control-label"><?php echo __('Văn bản'); ?></label>
    ...
    <fieldset class="fieldset">
        <div class="control-group">
            <label for="date" class="control-label"><?php echo __('Ngày bắt đầu'); ?></label>
    ...
    <fieldset class="fieldset">
        <div class="control-group">
            <label for="dateEnd" class="control-label"><?php echo __('Ngày kết thúc'); ?></label>
    ...
    <fieldset class="fieldset">
        <div class="control-group">
            <label for="weight" class="control-label"><?php echo __('Trọng lượng'); ?></label>
    ...
    <div class="form-actions">
        <div class="pull-right">
            <input class="btn btn-primary btn-large" type="submit" name="Submit" value="Lưu thay đổi">
        </div>
    </div>
</form>