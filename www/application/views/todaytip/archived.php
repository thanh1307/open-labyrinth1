    ...
    <div class="pull-right">
        <div class="btn-group">
            <a class="btn btn-primary" href="<?php echo URL::base(); ?>TodayTipManager/addTip">
                ...
                <?php echo __('Thêm một Lời khuyên'); ?></a>
        </div>
    </div>
    <h1><?php echo __('Lời khuyên hôm nay đã được lưu trữ'); ?></h1>
</div>
                ...
                <td>
                    ...
                    <div class="modal hide alert alert-block alert-error fade in" id="delete-tip-<?php echo $tip->id; ?>">
                        ...
                        <div class="modal-body">
                            ...
                            <p>
                                <a class="btn btn-danger" href="<?php echo URL::base() . 'TodayTipManager/deleteArchiveTip/' . $tip->id; ?>"><?php echo __('Xóa'); ?></a> <button class="btn" data-dismiss="modal" aria-hidden="true">Close</button>
                            </p>
                        </div>
                    </div>
                </td>
