...
<h1><?php echo __('Tìm kiếm theo thuật ngữ "'); ?><?php if(isset($searchText)) echo $searchText; ?>"</h1>
...
<table class="table table-striped table-bordered">
    ...
    <?php } else { ?>
    <tr>
        <td colspan="4"><?php echo __('Không tìm thấy kết quả'); ?></td>
    </tr>
    <?php } ?>
    </tbody>
</table>