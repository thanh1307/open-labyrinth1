...
<form class="form-horizontal" id="form1" name="form1" method="post"
    ...
    <fieldset class="fieldset">
        <div class="control-group">
            <label for="topicname" class="control-label"><?php echo __('tên chủ đề'); ?></label>
    ...
    <fieldset class="fieldset">
        ...
        <div class="control-group">
            <label class="control-label"><?php echo __('Hiển thị'); ?></label>

            <div class="controls">
                <label class="radio">
                    <input name="security" type="radio" value="0" <?php if (isset($templateData['security'])) { echo ($templateData['security'] == 0) ? 'checked="checked"' : ''; } else { echo 'checked="checked"'; } ?>><?php echo __('Hiển thị'); ?>
                </label>
            </div>
            <div class="controls">
                <label class="radio">
                    <input name="security" type="radio" value="1" <?php if (isset($templateData['security'])) { echo ($templateData['security'] == 1) ? 'checked="checked"' : ''; } ?>><?php echo __('Ẩn'); ?>
                </label>
            ...
            <?php if (isset($templateData['status'])) { ?>
                <div class="control-group">
                    ...
                    <?php if ( isset($templateData['topic']) && $templateData['topic']->status == 0 ) {?>
                        <div class="controls">
                            <label class="radio">
                                <input name="status" type="radio" value="0"  checked="checked"><?php echo __('Không hoạt động'); ?>
                            </label>

                            <label class="radio">
                                <input name="status" type="radio" value="1"><?php echo __('Hoạt động'); ?>
                            </label>
                        </div>
                    <?php } else {?>
        ...
        <?php } else {?>
            <div class="control-group">
                ...
                <div class="controls">
                    <label class="radio">
                        <input name="status" type="radio" value="0"  checked="checked"><?php echo __('Không hoạt động'); ?>
                        <?php if(isset($templateData['topic'])) echo '- Hãy chờ đến khi quản trị viên duyệt!';?>
                    </label>
                </div>
            </div>
        <?php } ?>
            ...
            <tr>
                ...
                <th style="text-align: left">
                    <a href="javascript:void(0);">
                        Người dùng <div class="pull-right"><i class="icon-chevron-down icon-white"></i></div>
                    </a>
                </th>
            </tr>
            </thead>
    ...
    <div class="form-actions">
        <div class="pull-right">
            <input class="btn btn-large btn-primary" type="submit" name="Submit"
                   value="<?php echo (isset($templateData['name'])) ? 'Chỉnh sửa chủ đề' : 'Thêm chủ đề'; ?>" onclick="return CheckForm();"></div>
        </div>
    </div>
