...
<form class="form-horizontal" id="conditionsForm" method="post" action="<?php echo URL::base().'webinarmanager/saveConditions'; ?>">
    <h1 class="page-header">
        <?php echo __('Trạng thái'); ?>
        <button class="btn btn-primary btn-large pull-right" type="submit"><?php echo __('Lưu thay đổi'); ?></button>
        <button class="btn btn-primary btn-large pull-right add-condition-js" type="button"><?php echo __('Thêm trạng thái'); ?></button>
    </h1>
    ...
    <table class="table table-striped table-bordered">
        ...
        if(count($templateData['conditions'])) {
            ...
            <tr>
                ...
                <td>
                    ...
                    <a class="btn btn-info" href="<?php echo URL::base().'webinarmanager/editCondition/'.$condition->id; ?>">
                        ...
                        <span class="visible-desktop">Chỉnh sửa</span>
                    </a>
                </td>
            ...
            <tr>
                <td><input class="code" readonly="readonly" type="text" placeholder="Không"></td>
                <td><input type="text" name="newConditionsName[]" placeholder="Tên kiểu"></td>
                <td></td>
                <td>
