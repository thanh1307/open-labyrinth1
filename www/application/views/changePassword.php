            ...
            <h1><?php echo __('Thay đổi mật khẩu người dùng'); ?></h1>
                        ...
                        <form class="form-horizontal" action="<?php echo URL::base(); ?>home/updatePassword" method="post" id="form1" name="form1">
                            <fieldset class="fieldset">
                                ...
                                <div class="control-group">
                                    <label for="upw" class="control-label">Mật khẩu cũ</label>
                                ...
                                <div class="control-group">
                                    <label for="newpswd" class="control-label">Mật khẩu mới</label>
                                ...
                                <div class="control-group">
                                    <label for="pswd_confirm" class="control-label">Nhập lại mật khẩu mới</label>
