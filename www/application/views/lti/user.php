...
<form class="form-horizontal left" method="post" action="<?php echo URL::base().'ltimanager/saveConsumer'; ?>">
    ...
    <fieldset>
        ...
        <button type="submit" class="btn btn-primary btn-large pull-right">Lưu thay đổi</button>
    </fieldset>
</form>
