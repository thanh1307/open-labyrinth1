...
<head>
    <meta charset="utf-8">
    <title><?php echo __('Lỗi') ?> > <?php echo __('Hệ thống'); ?></title>
...
<body>
    ...
    <div id="kohana_error" style="display: none">
                ...
                <?php foreach (Debug::trace($trace) as $i => $step): ?>
                    <li>
                        ...
                        <span class="file">
                            ...
                            <?php else: ?>
                                {<?php echo __('Cuộc gọi nội bộ PHP') ?>}
                            <?php endif ?>
                        </span>
                            &raquo;
                            <?php echo $step['function'] ?>(<?php if ($step['args']): $args_id = $error_id.'args'.$i; ?><a href="#<?php echo $args_id ?>" onclick="return koggle('<?php echo $args_id ?>')"><?php echo __('tranh luận') ?></a><?php endif ?>)
                        </p>
        ...
        <div id="<?php echo $env_id ?>" class="content collapsed">
            ...
            <h3><a href="#<?php echo $env_id = $error_id.'environment_included' ?>" onclick="return koggle('<?php echo $env_id ?>')"><?php echo __('Tệp được bao gồm') ?></a> (<?php echo count($included) ?>)</h3>
