 ...
 */
?>
<h1><?php echo __('Khôi phục mật khẩu tự động'); ?></h1>
...
<form class="form-horizontal" action="<?php echo URL::base(); ?>home/updateResetPassword" method="post">
    <fieldset class="fieldset">
        ...
        <div class="control-group">
            <label for="newpswd" class="control-label"><?php echo __('Mật khẩu mới'); ?>:</label>
            <div class="controls">
                <input type="password" id="newpswd" name="newpswd" size="30" />
            </div>
        </div>
        <div class="control-group">
            <label for="pswd_confirm" class="control-label"><?php echo __('Xác nhận mật khẩu mới'); ?>:</label>
            <div class="controls">
