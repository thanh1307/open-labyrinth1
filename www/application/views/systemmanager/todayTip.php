...
<form class="form-horizontal" name="todaytip_form" action="<?php echo URL::base() . 'systemManager/updateTodayTip/'; ?>" method="post">
    ...
    <fieldset class="fieldset">
        <legend><?php echo __("Lời Khuyên Hôm Nay"); ?></legend>
        <div class="control-group">
            <label class="control-label" for="title"><?php echo __('Tiêu đề'); ?></label>
            <div class="controls">
                <input class="span5" id="title" name="title" value="<?php echo $templateData['todayTip']->title; ?>" />
                <span class="help-block">
                    <small>
                        <span class="label label-info"><?php echo __('Tiêu đề sẽ không được hiển thị nếu bị bỏ trống.'); ?></span>
                    </small>
                </span>
            </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="text"><?php echo __('Nội dung lời khuyên'); ?></label>
            <div class="controls">
