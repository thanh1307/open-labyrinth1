...
<form class="form-horizontal" name="support_form" action="<?php echo URL::base() . 'systemManager/updateSupportEmails'; ?>" method="post">
    ...
    <fieldset class="fieldset">
        ...
        <div class="control-group">
            <label class="control-label" for="short_text"><?php echo __('Email hỗ trợ'); ?></label>
            <div class="controls">
            ...
            <div class="controls">
                ...
                <span class="help-block">
                    <small>
                        ...
                        <a href="#" rel="tooltip" title="<?php echo __('Vui lòng nhập email của bạn cách nhau bằng dấu phẩy.'); ?>"><?php echo __('Vui lòng nhập email của bạn cách nhau bằng dấu phẩy'); ?>:</a>
