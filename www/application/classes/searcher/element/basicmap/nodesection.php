...
class Searcher_Element_BasicMap_NodeSection extends Searcher_Element_BasicMap {
    public function __construct($mapId, $fields) {
        parent::__construct($mapId, $fields);
    }

    protected function getTable() {
        return Model_Leap_Map_Node_Section::table();
    }

    protected function getModelName() {
        return 'map_node_section';
    }

    protected function getURL($object) {
        return URL::base() . 'nodeManager/editSection/' . $this->mapId . '/' . $object->id;
    }
