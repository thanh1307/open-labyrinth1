...
class Controller_PopupManager extends Controller_Base {
    ...
    public function action_index()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Tin nhắn'))->set_url(URL::base() . 'popupManager/index/' . $mapId));
    }
    ...
    public function action_newPopup()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Thêm tin nhắn'))->set_url(URL::base() . 'popupManager/addMessage/' . $mapId));
    }
    ...
    public function action_editPopup()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Chỉnh sửa tin nhắn'))->set_url(URL::base() . 'popupManager/editPopup/' . $mapId));
    }
