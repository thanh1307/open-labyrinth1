...
class Controller_DTopicManager extends Controller_DForumManager {
    ...
    public function action_addTopic() {
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Thêm chủ đề vào diễn đàn'))->set_url(URL::base() . 'dtopicManager/addTopic'));
    ...
    public function action_editTopic() {
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Chỉnh sửa chủ đề'))->set_url(URL::base() . 'dtopicManager/editTopic'));
    ...
    public function action_editMessage(){
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Chỉnh sửa ID tin nhắn:').' '. $messageId)->set_url(URL::base() . 'dtopicManager/editMessage/' . $messageId));
