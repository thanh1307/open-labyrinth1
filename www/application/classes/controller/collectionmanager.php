...
class Controller_CollectionManager extends Controller_Base {
    ...
    public function before() {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Bộ sưu tập của tôi'))->set_url(URL::base() . 'collectionManager'));
    }
    ...
    public function action_addCollection() {
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Tạo bộ sưu tập'))->set_url(URL::base() . 'collectionManager/addCollection'));
    ...
    public function action_viewAll()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Xem bộ sưu tập'))->set_url(URL::base() . 'collectionManager/viewAll/' . $collectionId));
    }
    ...
    public function action_editCollection()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Chỉnh sửa Bộ sưu tập'))->set_url(URL::base() . 'collectionManager/editCollection/' . $collectionId));
    }
