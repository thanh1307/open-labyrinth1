...
class Controller_TodayTipManager extends Controller_Base {
    ...
    public function before() {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Quản lý Lời khuyên hôm nay'))->set_url(URL::base() . 'TodayTipManager/index'));
    ...
    public function action_index() {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Lời khuyên gần đây')));
    ...
    public function action_archived() {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Nhận hướng dẫn')));
    ...
    public function action_addTip() {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Tạo hướng dẫn')));
    ...
    public function action_editTip() {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Chỉnh sửa hướng dẫn')));
