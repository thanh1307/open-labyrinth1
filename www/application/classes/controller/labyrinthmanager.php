...
class Controller_LabyrinthManager extends Controller_Base
{
    ...
    {
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Sáng tạo cá nhân'))->set_url(URL::base() . 'labyrinthManager/addManual'));
    ...
    public function action_caseWizard()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Sáng tạo từng bước'))->set_url(URL::base() . 'labyrinthManager/caseWizard'));
    ...
    public function action_global()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Chi tiết'))->set_url(URL::base() . 'labyrinthManager/global/id/' . $mapId));
    }
    ...
    public function action_search()
    {
        ...
        $searcher->addElement(
            new Searcher_Element_BasicMap_Node(
                ...
                array(
                    array('field' => 'id', 'label' => 'Id'),
                    array('field' => 'title', 'label' => 'Tiêu đề'),
                    array('field' => 'text', 'label' => 'Nội dung')
                )
            )
        );
        ...
        $searcher->addElement(new Searcher_Element_BasicMap_Counter($mapId, array(
            array('field' => 'id', 'label' => 'Id'),
            array('field' => 'name', 'label' => 'Tên'),
            array('field' => 'description', 'label' => 'Mô tả'),
            array('field' => 'start_value', 'label' => 'Giá trị ban đầu')
        )));
        $searcher->addElement(new Searcher_Element_Question($mapId, array(
            array('field' => 'id', 'label' => 'Id'),
            array('field' => 'stem', 'label' => 'Nội dung'),
            array('field' => 'response', 'label' => 'Đáp ứng', 'type' => 'response'),
            array('field' => 'feedback', 'label' => 'Phản hồi', 'type' => 'response')
        )));
        $searcher->addElement(new Searcher_Element_Chat($mapId, array(
            array('field' => 'id', 'label' => 'Id'),
            array('field' => 'stem', 'label' => 'Nội dung'),
            array('field' => 'question', 'label' => 'Câu hỏi', 'type' => 'element'),
            array('field' => 'response', 'label' => 'Đáp ứng', 'type' => 'element')
        )));
        $searcher->addElement(new Searcher_Element_Vpd($mapId, array(
            array('field' => 'id', 'label' => 'Id'),
            array('field' => 'value', 'label' => 'Value', 'type' => 'Phần tử')
        )));
