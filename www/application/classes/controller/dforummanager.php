...
class Controller_DForumManager extends Controller_Base {
    ...
    {
        parent::before();
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Diễn đàn'))->set_url(URL::base() . 'dforumManager'));
    ...
    public function action_viewForum() {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Xem').' '. $this->templateData['forum']['name'])->set_url(URL::base() . 'dforumManager/ViewForum/' . $this->request->param('id', 0)));
    ...
    public function action_addForum(){
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Thêm diễn đàn'))->set_url(URL::base() . 'dforumManager/addForum'));
    ...
    public function action_editForum(){
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Chỉnh sửa diễn đàn'))->set_url(URL::base() . 'dforumManager/editForum'));
    ...
    public function action_editMessage(){
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Chỉnh sửa ID tin nhắn').' '. $messageId)->set_url(URL::base() . 'dforumManager/editMessage/' . $messageId));
