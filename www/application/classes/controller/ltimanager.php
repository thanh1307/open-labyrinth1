...
class Controller_LtiManager extends Controller_Base {
    ...
    public function before() {
        parent::before();
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__("Quản lý LTI"))->set_url(URL::base().'ltimanager/index'));
    }
    ...
    public function action_providers()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Nhà cung cấp')));
    }
    ...
    public function action_providerView()
    {
        ...
        $this->template->set('templateData', $this->templateData);
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Quản lý nhà cung cấp')));
    }
    ...
    public function action_index()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Người dùng')));
    }
    ...
    public function action_userView()
    {
        ...
        $this->template->set('templateData', $this->templateData);
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Quản lý người dùng')));
    }
...
EOD;
        ...
        header("Độ dài nội dung: ". strlen($xml).";");
        header("Bố trí nội dung: tệp đính kèm; tên tập tin=$key.xml");
        header("Kiểu nội dung: application/octet-stream; ");
        header("Mã hóa chuyển nội dung: nhị phân");
        echo $xml;
        exit;
    }
}