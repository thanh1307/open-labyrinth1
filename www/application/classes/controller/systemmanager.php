...
class Controller_SystemManager extends Controller_Base {
    ...
    public function before()
    {
        ...
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Cài đặt hệ thống'))->set_url(URL::base() . 'systemmanager'));
    ...
    public function action_index()
    {
        ...
        $this->templateData['tabsName'][0] = __('Cài đặt khôi phục mật khẩu');
        ...
        $this->templateData['tabsName'][1] = __('Tải lên phương tiện - Thông báo bản quyền');
        ...
        $this->templateData['tabsName'][2] = __("Hỗ trợ");
        ...
        $this->templateData['tabsName'][5] = __("Thông báo Twitter");
    ...
    public function action_uploadReadMe ()
    {
        ...
        if ($file["error"]) {
            ...
            Notice::add('Tải tệp thành công.', 'success');
        } else {
            Notice::add('Tải tệp PDF.', 'error');
        }
