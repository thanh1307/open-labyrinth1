...
class Controller_Vocabulary_Vocablets_Manager extends Controller_Base
{
    ...
    public function before()
    {
        ...
        parent::before();
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Quản lý thư viện RDF'))->set_url(URL::base() . 'vocabulary/manager'));
        Breadcrumbs::add(Breadcrumb::factory()->set_title(__('Phần mở rộng ngữ nghĩa'))->set_url(URL::base() . 'vocabulary/mappings/manager'));
    }
    ...
    public function action_index()
    {
        ...
        $this->templateData['title'] = "Quản lý phần mở rộng ngữ nghĩa";
