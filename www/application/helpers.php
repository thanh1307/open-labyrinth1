...
{
    return array(
        1 => __('Tệp tải lên vượt quá mức cho phép trong php.ini'),
        2 => __('Tệp tải lên vượt quá mức chỉ định trong biểu mẫu HTML'),
        3 => __('Tệp đã tải lên chỉ được tải lên một phần'),
        4 => __('Không có tệp nào được tải lên'),
        6 => __('Thiếu một thư mục tạm thời'),
        7 => __('Ghi tệp vào đĩa thất bại'),
        8 => __('Tiện ích mở rộng PHP đã dừng tải tệp lên.'),
    );
}