	...
	tinymce.html.DomParser = function(settings, schema) {
		...
		if (settings.remove_trailing_brs) {
			self.addNodeFilter('br', function(nodes, name) {
				...
				// Must loop forwards since it will otherwise Xóa tất cả brs in <p>a<br><br><br></p>
				for (i = 0; i < l; i++) {
					node = nodes[i];
					parent = node.parent;
				...
				if (names) {
					...
					while (i--) {
						...
						if (callbackList) {
							...
							// Xóa tất cả callbacks if there isn't a specified callback or there is no callbacks left
...
*/
		...
		setHTML : function(element, html) {
			...
			return self.run(element, function(element) {
				if (isIE) {
					// Xóa tất cả child nodes, IE keeps empty text nodes in DOM
					...
					try {
						...
						// Thêm tất cả children from div to target
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			'JustifyLeft,JustifyCenter,JustifyRight,JustifyFull' : function(command) {
				...
				// Xóa tất cả other alignments first
