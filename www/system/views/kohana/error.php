...
<div id="kohana_error">
		...
		<?php foreach (Debug::trace($trace) as $i => $step): ?>
			<li>
				<p>
					...
					&raquo;
					<?php echo $step['function'] ?>(<?php if ($step['args']): $args_id = $error_id.'args'.$i; ?><a href="#<?php echo $args_id ?>" onclick="return koggle('<?php echo $args_id ?>')"><?php echo __('lập luận') ?></a><?php endif ?>)
				</p>
	...
	<div id="<?php echo $env_id ?>" class="content collapsed">
		...
		<h3><a href="#<?php echo $env_id = $error_id.'environment_included' ?>" onclick="return koggle('<?php echo $env_id ?>')"><?php echo __('Tệp tin đã bao gồm') ?></a> (<?php echo count($included) ?>)</h3>
